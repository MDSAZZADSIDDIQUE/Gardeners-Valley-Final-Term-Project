...
<div class="container">
    ...
    <div class="backgroundImage">
        ...
        <div class="main">
            <form action="../controllers/php/editing_user.php?userID=<?php echo "{$userID}"; ?>" id="registration_form"
                  method="post"
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <input type="text" name="firstName" id="first_name" <?php echo "value={$firstName}" ?>>

                                <small id="invalid_first_name_error_message"></small>
                            </td>
                            <td>
                                <label for="last_name">Last name : </label>
                                <input type="text" name="lastName" id="last_name" <?php echo "value={$lastName}" ?>>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="date" name="dateOfBirth"
                                       id="date_of_birth" <?php echo "value={$dateOfBirth}" ?>>
                                <br>
                        ...
                        <tr>
                            <td>
                                ...
                                <select name="role" id="role">
                                    <option value="Buyer" <?php if ($role == 'Buyer') {
                                        echo "selected";
                                    } ?>>Buyer
                                    </option>
                                    <option value="Seller" <?php if ($role == 'Seller') {
                                        echo "selected";
                                    } ?>>Seller
                                    </option>
                                    <option value="Expert" <?php if ($role == 'Expert') {
                                        echo "selected";
                                    } ?>>Expert
                                    </option>
                                    <option value="Delivery man" <?php if ($role == 'Delivery Man') {
                                        echo "selected";
                                    } ?>>Delivery man
                                    </option>
                                </select>
                            ...
                            <td>
                                ...
                                <input type="email" name="emailAddress"
                                       id="email_address" <?php echo "value={$emailAddress}" ?>>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="password" name="confirmPassword"
                                       id="confirm_password" <?php echo "value={$password}" ?>>
