...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/view_all_shops.css">
    ...
    <div class="backgroundImage">
        ...
        <div class="main">
            <table>
                ...
                <?php
                include_once "../controllers/php/show_all_shop.php";
...
<script>
    ...
    function deleteUser(userID) {
        ...
        xhttp.open('GET', '../controllers/php/delete_shop.php?shop_id=' + userID, true);
    ...
    function deletingShop(userID) {
        window.location.replace("../controllers/php/deleting_shop.php?shopID=" + userID);
    }
    ...
    function searchUser() {
        ...
        let xhttp = new XMLHttpRequest();
        xhttp.open('GET', '../controllers/php/search_shop.php?searchString=' + searchString, true);
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
