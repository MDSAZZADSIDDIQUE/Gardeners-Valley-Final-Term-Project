...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/view_all_products.css">
    ...
    <div class="backgroundImage">
        ...
        <div class="main">
            <table>
                ...
                <?php
                include_once "../controllers/php/show_all_products.php";
...
<script>
    ...
    function deleteUser(userID) {
        ...
        xhttp.open('GET', '../controllers/php/delete_product.php?userID=' + userID, true);
    ...
    function deletingProduct(userID) {
        window.location.replace("../controllers/php/deleting_product.php?productID=" + userID);
    }
    ...
    function searchUser() {
        ...
        let xhttp = new XMLHttpRequest();
        xhttp.open('GET', '../controllers/php/search_product.php?searchString=' + searchString, true);
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
