    ...
    <div class="backgroundImage">
        ...
        <div class="main">
            <table>
                ...
                <?php
                include_once "../controllers/php/show_all_posts.php";
...
<script>
    ...
    function deleteUser(userID) {
        ...
        xhttp.open('GET', '../controllers/php/delete_post.php?postID=' + userID, true);
    ...
    function deletingPost(userID) {
        window.location.replace("../controllers/php/deleting_post.php?postID=" + userID);
    }
    ...
    function searchUser() {
        ...
        let xhttp = new XMLHttpRequest();
        xhttp.open('GET', '../controllers/php/search_post.php?searchString=' + searchString, true);
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
