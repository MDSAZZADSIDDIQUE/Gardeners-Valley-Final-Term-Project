...
function show_user()
{
    ...
    while ($productInformation = mysqli_fetch_array($productsInformation)) {
        ...
        echo "<td><img width='100px' height='auto' class='tableImage' src='{$productInformation[3]}'></td>";
        echo "<td>{$productInformation[4]}</td>";
        echo "<td>{$productInformation[5]}</td>";
        echo "<td class='editRow'><a href='edit_product.php?editPost={$productInformation[0]}'>Edit</a></td>";
